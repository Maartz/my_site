...
With ES6, the `class` keyword and all the OO* ceremony comes in `Javascript`.
...
We can see in ES5 style that we have a function, which return a function, which use a method with a lambda AKA anonymous...function!
